      ...
      <aside className="w-64 bg-[#0f172a] text-white flex flex-col shrink-0">
        ...
        <div className="p-5 border-b border-white/[0.06]">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#64748b]">Öğretmen Paneli</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 border-t border-white/[0.06]">
          <div className="flex items-center gap-3 mb-3">
            <div className="w-9 h-9 rounded-full bg-gradient-to-br from-[#4f46e5] to-[#7c3aed] flex items-center justify-center text-sm font-bold">
              {user?.name?.charAt(0) || 'Ö'}
            </div>
            <div className="flex-1 min-w-0">
              <p className="text-sm font-medium truncate">{user?.name || 'Öğretmen'}</p>
              <p className="text-xs text-[#64748b]">Öğretmen</p>
            </div>
          </div>
          <button
